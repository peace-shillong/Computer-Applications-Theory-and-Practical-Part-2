...
#define HAVE_ADDR_INFO_STRUCT 1
...
//Define if you have the gethostnyname_r function
...
//define if you have the resolv library 9-lresolv0
...
//define if yo have the <string.h> header file
...
//define if the system has the type struct sockaddr_stotage
...
//define if system supports IPv6
#define IPV6 1
...
//define if system supports IP multicast
#define MCAST 1
...
//define if system supports UNIX domain sockets
#define UNIXDOMAIN 1
...
//define to _ss_family if sockaddr_storage has that instead of ss_family
//#undef ss_family
