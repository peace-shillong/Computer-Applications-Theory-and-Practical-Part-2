...
ResultSet res=st.executeQuery("select FirstName, LastName, B.ISBN, Title from Authors A, AuthorISBN B, Titles T where A.AuthorID=B.AuthorID and T.ISBN=B.ISBN order by Lastname, FirstName ");
